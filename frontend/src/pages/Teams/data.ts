...
const WORKFRONT_MEMBERS: Member[] = [
  {
    ...
    name: 'Namratha R',
    bio:
      'I am a passionate and goal-oriented individual with strong leadership, communication, and problem-solving skills. I thrive in challenging environments and focus on achieving shared goals.',
    photo: '/images/contributors/namratha-r.jpeg',
    photoPosition: 'center',
    project: {
      name: 'Audit Automation',
      description:
        'An intelligent, rule-based automation engine on Adobe Workfront that streamlines the audit request lifecycle — auto-classifying intakes, routing tasks, and escalating approvals. Powered by Workfront Fusion and Claude (LLM) for smart categorization, it removes manual handoffs and brings consistency to audit workflows.',
      url: null,
    },
