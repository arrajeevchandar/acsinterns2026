...
import { createPortal } from 'react-dom';
import type { Member, Team } from './data';
>>>>>>> main
...
=======
  ...
  const teamIndex = Math.max(0, ['ui', 'data', 'dacoe', 'aem', 'workfront', 'content'].indexOf(team.id));
  ...
  const modal = (
    <div className="member-modal__backdrop" onClick={onClose}>
      <div className="member-modal__panel glass" onClick={(event) => event.stopPropagation()}>
        <button className="member-modal__close" onClick={onClose} aria-label="Close" type="button">
>>>>>>> main
...
<<<<<<< HEAD
              {member.university} &middot; {member.program}
=======
              {member.university} &middot; {member.batch}
>>>>>>> main
            </p>
...
<<<<<<< HEAD
              ...
              <p className="member-modal__project-summary">{member.project.summary}</p>
              {member.project.url && (
                <a
...
=======
            ...
            <div className="member-modal__stack">
              {member.skills.map((skill) => (
                <span key={skill} className="member-modal__chip">{skill}</span>
>>>>>>> main
              ))}
            </div>
          </div>
